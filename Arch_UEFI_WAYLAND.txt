...
# ===================================================
# 3. СОЗДАНИЕ EFI СИСТЕМНОГО РАЗДЕЛА (ESP)
# ===================================================
# -n 1::+1024M: раздел 1, начало автоматически, размер 1024M (1GB)
# --typecode=1:ef00: тип EF00 (EFI System)
# --change-name=1:'Раздел Efi Arch Linux': имя раздела
sgdisk -n 1::+1024M --typecode=1:ef00 --change-name=1:'Раздел Efi Arch Linux' /dev/sda
# ===================================================
# 4. СОЗДАНИЕ КОРНЕВОГО РАЗДЕЛА (/)
# ===================================================
# -n 2::-4G: раздел 2, начало после предыдущего, размер до последних 4ГБ
# --typecode=2:8300: тип 8300 (Linux Filesystem)
# --change-name=2:'Системный раздел Arch Linux': имя раздела
sgdisk -n 2::-4G --typecode=2:8300 --change-name=2:'Системный раздел Arch Linux' /dev/sda
# ===================================================
# 5. СОЗДАНИЕ SWAP-РАЗДЕЛА
# ===================================================
# -n 3::-0: раздел 3, начало после предыдущего, размер весь остаток
# --typecode=3:8200: тип 8200 (Linux Swap)
# --change-name=3:'Раздел подкачки Arch Linux': имя раздела
