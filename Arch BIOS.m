...
##############################################################################
##       Переменная параметров монтирования BTRFS в FSTAB                   ##
## Замените 'defaults'в таблице на параметры монтирования BTRFS после теста ##
...
#############################################################
#             Параметры монтирования BTRFS в FSTAB          #
#############################################################
#             Параметр FSTAB     #  defaults                #
#############################################################

#############################################################
#             Разметка диска HDD/SSD                        #
#############################################################
#             Диск HDD/SSD       #  sdx                     #
#############################################################

#############################################################
#             Разделы диска HDD/SSD после разметки          #
#############################################################
#             BIOS Boot раздел   #  sda1                    #
#############################################################
#             Root раздел        #  sda2                    #
#############################################################
#             Swap раздел        #  sda3                    #
...
echo "## ⚠️ ВНИМАНИЕ: УСТАНОВКА ВИДЕОДРАЙВЕРОВ ОБЯЗАТЕЛЬНА ПЕРЕД DE/WM!   ##"
...
# Этот блок выполняется в Live-среде ПОСЛЕ выхода из chroot
umount -R /mnt
swapoff -a
poweroff
