...
# с прошивкой BIOS и таблицей разделов MBR.
# ################################################################
...
pacman -Sy
pacman -S --noconfirm noto-fonts noto-fonts-emoji noto-fonts-cjk ttf-dejavu ttf-liberation
...
# # bootloader-id (только UEFI)# Grub Arch Linux        # ЭТАП 1 (сейчас)         #
# # Параметры монтирования     # defaults               # ЭТАП 1 (сейчас)         #
# # Локаль (locale.gen)        # XXXX                   # ЭТАП 1 (сейчас)         #
# # Раскладка (loadkeys)       # YYYY                   # ЭТАП 1 (сейчас)         #
# # Шрифт консоли (font)       # ZZZZ                   # ЭТАП 1 (сейчас)         #
# #################################################################################

# ###################################################################################
# # СПРАВКА: Часто используемые языковые параметры (замените XXXX, YYYY, ZZZZ)  #
# ###################################################################################
# # Страна    # locale.gen # loadkeys, keymap # font              # Комментарий     #
# ###################################################################################
# # Россия    # ru_RU      # ru               # cyr-sun16         # Кириллица       #
# # Украина   # uk_UA      # uk               # UniCyr_8x16       # Кириллица       #
# # Беларусь  # be_BY      # by               # cyr-sun16         # Кириллица       #
# # Германия  # de_DE      # de               # lat9w-16          # Латиница        #
# # Франция   # fr_FR      # fr               # lat9w-16          # Латиница        #
# # Испания   # es_ES      # es               # lat9w-16          # Латиница        #
# # Италия    # it_IT      # it               # lat9w-16          # Латиница        #
# # США       # en_US      # us               # lat9w-16          # Латиница        #
# # Türkiye   # tr_TR      # trq              # latarcyrheb-sun16 # Латиница+Тюрк.  #
# # Израиль   # he_IL      # il               # latarcyrheb-sun16 # Иврит           #
# # Япония    # ja_JP      # jp106            # jiskp16           # Кириллица+Кана  #
# # Китай     # zh_CN      # cn               # ter-v16n          # CJK             #
# ###################################################################################
...
sgdisk -o /dev/sdx
sgdisk -n 1:0:+4M -t 1:ef02 -c 1:'BIOS Boot Arch' /dev/sdx
...
pacstrap /mnt noto-fonts noto-fonts-emoji noto-fonts-cjk ttf-dejavu ttf-liberation
...
# ##################################################
# ## 🔐 Блок 8: НАСТРОЙКА HOST И ROOT (CHROOT) #####
# ##################################################
#
...
sed -i '/GRUB_CMDLINE_LINUX_DEFAULT/s/quiet/quiet splash resume=UUID='${SWAP_UUID}'/' /etc/default/grub
...
pacman -S --noconfirm chromium htop cpu-x gparted qbittorrent libreoffice-fresh-YYYY archlinux-wallpaper
