...
# # Локаль (locale.gen)        # ru_RU                  # ЭТАП 1 (сейчас)         #
# # Раскладка (loadkeys)       # ru                     # ЭТАП 1 (сейчас)         #
# # Шрифт консоли              # cyr-sun16              # ЭТАП 1 (сейчас)         #
# #################################################################################

# 💡 СОВЕТ: После ЭТАПА 1 проверьте, что в файле больше нет строки "sdx".
#           После ЭТАПА 2 — что нет "sda1", "sda2", "sda3".

# ###################################################################################
# # СПРАВКА: Часто используемые языковые параметры (замените ru_RU, ru, cyr-sun16)  #
# ###################################################################################
