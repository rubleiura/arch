...
pacstrap /mnt btrfs-progs lvm2 cryptsetup
pacstrap /mnt linux-lts linux-firmware amd-ucode memtest86+ nano reflector
pacstrap /mnt grub grub-btrfs os-prober snapper snap-pac
...
GRUB_CMDLINE_LINUX="cryptdevice=UUID=${CRYPT_UUID}:cryptlvm root=/dev/vg_main/lv_root rootflags=subvol=@ resume=UUID=${SWAP_UUID}"
GRUB_PRELOAD_MODULES="part_gpt part_msdos"
# GRUB_ENABLE_CRYPTODISK=y  # ← НЕ НУЖЕН, так как /boot НЕ зашифрован
