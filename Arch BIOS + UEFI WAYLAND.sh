...
## Изменять переменные разделов(sda2,sda3,sda4) необходимо в первую     ##
...
#                        Variable                           #
#############################################################
# Country # loadkeys, keymap #  locale.gen   #  font        #
#############################################################
# Russia  #  ru              #  ru_RU.UTF-8  #  cyr-sun16   #
#############################################################

#############################################################
#            Настройки языка для справки                    #
#           Language settings for reference                 #
#############################################################
# Country # loadkeys, keymap #  locale.gen  #  font         #
#############################################################
# Russia  #  ru              #  ru_RU       #  cyr-sun16    #
# Ukraine #  uk              #  uk_UA       #  UniCyr_8x16  #
# Belarus #  by              #  be_BY       #  UniCyr_8x16  #
# Germany #  de              #  de_DE       #  lat9w-16     #
# France  #  fr              #  fr_FR       #  lat9w-16     #
# Spain   #  es              #  es_ES       #  lat9w-16     #
# Italy   #  it              #  it_IT       #  lat9w-16     #
# USA     #  en              #  en_US       #  lat9w-16     #
#############################################################
...
#############################################################
# Разделы диска для монтирования #  sda1 sda2 sda3 sda4 sda #
#############################################################
