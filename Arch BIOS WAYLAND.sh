...
echo "##  <<< ЗАМЕНИТЕ ПЕРЕМЕННЫЕ sda1 sda2 sda3 НА ИМЯ >>>  ##"
echo "## <<< РАЗДЕЛОВ ПОСЛЕ РАЗМЕТКИ ДИСКА SSD, ЛИБО HDD >>> ##"
echo "#########################################################"
echo ""
echo ""
...
echo "##    <<< СЛЕДУЙТЕ ИНСТРУКЦИИ video_drivers_guide.sh >>>            ##"
echo "######################################################################"
echo ""
echo "##############################################"
...
#    из файла 'video_drivers_guide.sh'.
...
#        (см. video_drivers_guide.sh) перед установкой DE/WM.
