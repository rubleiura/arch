...
# следуя инструкции video_drivers_guide.sh после Блока 11 и до
...
# Обновление списка зеркал (избегаем запуска reflector в chroot)
pacman -Syy
...
# Установка загрузчика и утилит (os-prober убран по умолчанию)
...
# echo "Установите драйверы согласно вашей видеокарте и инструкции video_drivers_guide.sh."
...
# ########################################################
# УДАЛЕНО: Использование стороннего репозитория делает этот блок неприемлемым.
# ########################################################
