...
# ########################################################
# ## 🔐 БЛОК 9: HOSTNAME И ПАРОЛЬ ROOT (chroot) #########
# ########################################################
#
...
# #######################################################
# ## 👤 БЛОК 10: ПОЛЬЗОВАТЕЛЬ И SUDO (chroot) ###########
# #######################################################
#
...
# #######################################################
# ## 🔧 БЛОК 11: УСТАНОВКА ЯДРА, GRUB, MKINITCPIO #######
# #######################################################
#
...
# #######################################################
# ## 🧰 БЛОК 12: СИСТЕМНЫЕ УТИЛИТЫ И WAYLAND (chroot) ###
# #######################################################
#
...
# ########################################################
# ## 🖥️ БЛОК 13: УСТАНОВКА ВИДЕО-ДРАЙВЕРА (chroot) #######
# ########################################################
#
...
######################################################
# ## 🌌 БЛОК 14: УСТАНОВКА ГРАФИЧЕСКОЙ СРЕДЫ ###########
# ######################################################
#
