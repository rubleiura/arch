...
# * Если у вас гибридная графика (Intel/AMD + NVIDIA): добавьте nvidia-prime
#   pacman -S --noconfirm nvidia-prime

# Для LTS-ядра:
# pacman -S --noconfirm nvidia-lts nvidia-utils nvidia-settings
# pacman -S --noconfirm lib32-nvidia-utils
# * Если у вас гибридная графика: добавьте nvidia-prime
...
##############################################################
### ЧАСТЬ 4: ПРОВЕРКА ПОСЛЕ УСТАНОВКИ И ПЕРЕЗАГРУЗКИ
##############################################################
