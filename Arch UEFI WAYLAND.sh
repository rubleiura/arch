...
#### Plasma ####
pacman -Syy
pacman -S --noconfirm plasma dolphin dolphin-plugins kate konsole skanpage skanlite gwenview elisa ffmpegthumbs
...
###  GNOME  ##
pacman -Syy
pacman -S --noconfirm gnome gnome-extra gnome-software xdg-desktop-portal-gnome
