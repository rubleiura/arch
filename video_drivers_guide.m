...
# ШАГ 3:  ИНСТРУМЕНТ ДЛЯ СВЯЗИ МЕЖДУ ПРИЛОЖЕНИЯМИ И АППАРАТНЫМ ОБЕСПЕЧЕНИЕМ:
### Необходим для всех видео карт
...
# ШАГ 4: КОНФИГУРАЦИЯ СИСТЕМЫ (в chroot):
...
# ШАГ 5: НАСТРОЙКА INITRAMFS (mkinitcpio) (в chroot):
...
# ШАГ 6: НАСТРОЙКА ГИБЕРНАЦИИ (в chroot):
