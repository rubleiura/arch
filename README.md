...
*   При установке драйверов **всегда** следуйте инструкции из файла `video_drivers_guide.m`.
...
*   **Не запускайте** `video_drivers_guide.m` как скрипт. Копируйте и вставляйте команды вручную.
