...
легко и быстро установить Arch Linux, как
и с помощью любого Bash-скрипта.

Удобством макета установки является полный контроль
установки системы, возможность редактировать макет,
изменять и добавлять необходимые компоненты по
своему усмотрению.


Если вас что-то не устраивает в данном установщике,
вы всегда можете его отредактировать, или установить
